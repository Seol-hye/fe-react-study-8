...
// 배열 안의 요소들을 하나씩 접근하면서 (반복실행) 수행 후 return 기능
...
arr.map( (item)=>{ // 매개변수 1개 선언된 콜백함수 -> item 배열의 요소값 주입
...
let result6 = menuArr.map((menu)=> "<p>" + menu + "</p>");  //()=>값     return값
console.log(result6);
...
// 3) find
let result10 = arr.find((value)=>{      // 못 찾으면 undefined
                    return value == 20;
                })
console.log(result10);

let result11 = arr.findIndex((value)=>{      // 못 찾으면 undefined
                    return value == 20;
                })
